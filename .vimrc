...
" Plugin 'nathanaelkane/vim-indent-guides' Plugin 'sjl/badwolf'
...
" C++17 Build & Run
autocmd FileType cpp nnoremap <C-b> :!clang++ -std=c++17 cp.cpp -o cp && ./cp<CR>

" Python3 Run
autocmd FileType python nnoremap <C-b> :AsyncRun python3 % <bar> checktime<CR>
